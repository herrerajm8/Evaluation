...
public class StudentLogin extends javax.swing.JFrame {
    ...
    public ArrayList<Student> getStudentList(){
        ...
        try{
            ...
            Student sto;
            while(rs.next()){
//                int idNumber, String fullName, int groupId, int class_List_id
                sto = new Student(rs.getInt("idNumber"), rs.getString("fullName"), rs.getInt("groupId"), rs.getInt("class_List_id"));
//                fac = new Faculty(rs.getInt("faculty_Id"),rs.getString("fullName"),rs.getString("course"),rs.getString("birthdate"),rs.getString("gender"));
    ...
    private void lbuttonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbuttonMouseClicked
        ...
        try{
            ...
            String sql = "SELECT * FROM `students` WHERE `fullName` = '"+uname+"' AND `password` = PASSWORD('"+pass+"')";
            String student;
            ResultSet rs = st.executeQuery(sql);
            System.out.println(sql);
            if(rs.next()){
                System.out.println("ni sod?");
                System.out.println(rs.getInt("groupId")+" "+rs.getString("userName"));
               new DashTeacherEval(rs.getInt("groupId"), rs.getString("userName")).setVisible(true);
            }
        }catch(Exception e){
